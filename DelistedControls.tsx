  ...
  return (
    <div className="flex flex-1 flex-wrap items-center gap-x-4 gap-y-2">
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative flex h-8 w-full max-w-xs items-center border border-border-strong bg-surface px-3 sm:w-64">
        ...
        <label className="flex h-8 items-center gap-2 border border-border-strong bg-surface px-3">
      ...
      <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
        <fieldset className="flex items-center gap-3">
          <legend className="sr-only">End state</legend>
            ...
            {END_STATES.map((s) => (
              <label key={s} className="flex cursor-pointer items-center gap-2 text-sm">
                <input
                  ...
                  className="h-3 w-3 accent-[var(--accent-strong)]"
                />
