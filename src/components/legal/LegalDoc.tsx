...
export function LegalDoc({
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pb-24 pt-28 md:px-8">
      ...
      <h1 className="mt-4 font-medium text-4xl leading-[1.08] tracking-[-0.03em] text-foreground md:text-5xl">
        {title}
      </h1>
...
export function LegalSection({
  ...
  return (
    <section id={id} className="scroll-mt-28">
      <h2 className="font-medium text-2xl tracking-[-0.02em] text-foreground">{title}</h2>
