...
export const ACTIVITY: ActivityEvent[] = [
  {
    ...
    "message": "Declared licence changed to Not stated. Commercial terms are no longer stated at the source.",
  ...
  },
  {
    ...
    "message": "Documentation Coverage fell 9 points: the source registry stopped responding, so several fields could no longer be retrieved.",
  ...
  },
  {
    ...
    "message": "Annotation stage now documented at the source. Lineage completeness rose to 100%.",
  ...
  },
  {
    ...
    "message": "Documentation Coverage fell 6 points: last-modified information is now over 14 months old.",
  ...
  },
  {
    ...
    "message": "Version v5.0 published. Per-file licence files retrieved again from the source.",
  ...
  },
  {
    ...
    "message": "documentation coverage fell 2 points on update-frequency decay.",
